...
class SystemService:
    ...
    def list_system_logs(self, resource_id, page, page_size, sort_keys, sort_dirs):
        # 业务逻辑
        try:
            # 查询数据库
            count, data = SystemSQL.list_operate_log(resource_id, page, page_size, sort_keys, sort_dirs)
            # 数据处理
            ret = []
            # 遍历
            for r in data:
